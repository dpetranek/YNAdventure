...
def adventure0007():
    ...
    decision = raw_input("We're to defeat King Eglon the Evil, bro! Join us?")
    if decision == "yes" or decision == "y":
...
def adventure0008():
    ...
    decision = raw_input("Will you attempt to strike him righteously?")
    if decision == "yes" or decision == "y":
        print "You attempt to try and hit him with a dogwalk 620 with a backside sickie, but he makes you biff!"
        #adventure0009()
    elif decision == "no" or decision == "n":
        print "What happens next?"
    else:
